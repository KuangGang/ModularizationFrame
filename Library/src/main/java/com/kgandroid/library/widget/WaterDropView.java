...
public class WaterDropView extends View {
    ...
    private WaterCircle topCircle;
    private WaterCircle bottomCircle;

    private Paint mPaint;
    private Path mPath;
    private float mMaxCircleRadius;//圆半径最大值
    private float mMinCircleRaidus;//圆半径最小值
    private Bitmap arrowBitmap;//半径
    private final static int BACK_ANIM_DURATION = 180;//回弹时间
    ...
    private void init(Context context, AttributeSet attrs) {
        topCircle = new WaterCircle();
        bottomCircle = new WaterCircle();
        mPath = new Path();
        mPaint = new Paint();
        ...
        arrowBitmap = ImageUtils.drawableToBitmap(drawable);
...
//        }
    ...
    public WaterCircle getTopCircle() {
        return topCircle;
    }

    public WaterCircle getBottomCircle() {
        return bottomCircle;
    }
