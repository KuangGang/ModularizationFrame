...
public class WaterDropListViewFooter extends LinearLayout {
	...
	public void setState(STATE state) {
		...
		if (state == STATE.ready) {
			...
			mHintView.setText(getResources().getString(R.string.listfooterview_ready));//松开载入更多
...
//			mHintView.setVisibility(View.VISIBLE);
//			mHintView.setText(getResources().getString(R.string.listfooterview_normal));//查看更多
		}
	}
	...
	private void initView(Context context) {
		...
		mProgressBar = (ProgressBar) moreView.findViewById(R.id.waterdroplistview_footer_progressbar);
		...
		if (android.os.Build.VERSION.SDK_INT > 22){
			mProgressBar.setIndeterminateDrawable(getResources().getDrawable(R.drawable.progressbar));
		}
	}
