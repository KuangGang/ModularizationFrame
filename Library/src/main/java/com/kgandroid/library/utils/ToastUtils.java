...
public final class ToastUtils {
    ...
    private static int yOffset         = (int) (64 * AppContextUtils.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes final int layoutId) {
        LayoutInflater inflate = (LayoutInflater) AppContextUtils.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(AppContextUtils.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(AppContextUtils.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(AppContextUtils.getContext());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(AppContextUtils.getContext(), spannableString, duration);
            } else {
                sToast = Toast.makeText(AppContextUtils.getContext(), text, duration);
            }
        }
