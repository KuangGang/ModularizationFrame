    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                dir = AppContextUtils.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = AppContextUtils.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
